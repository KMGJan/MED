...
From this point onwards, we will use the datasets available in the package [PlanktonData](https://kmgjan.github.io/PlanktonData/). All the raw data come from [SHARKweb](https://sharkweb.smhi.se/hamta-data/).
