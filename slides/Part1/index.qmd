...
library(readr)
set.seed(123)
tibble::tibble(Month = sample(month.abb, 100, replace = TRUE),
       Genus = sample(c("Acartia", "Centropages", "Temora"), 100, replace = TRUE),
       Abundance = sample(seq(1,20,0.001), 100)) |> 
  readr::write_csv("./../../assets/data/Example_1.csv") 
